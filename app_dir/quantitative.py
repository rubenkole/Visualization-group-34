...
def update():
    ...
    px.yaxis.axis_label = x_axis.value
...
px.xaxis.axis_label = "Categories"
...
# Create three select menus. One for the x-axis and one for the y-axis and one for the color
...
# Code beyond this point (line 261-284) was taken and edited
